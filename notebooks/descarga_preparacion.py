...
df.columns = ["Género","Grupo etario","Código de la entidad","Nombre de la entidad","Régimen","Tipo de afiliado","Estado del afiliado","Condición del beneficiario","Zona de Afiliación","Departamento","Municipio","Nivel del Sisbén","Grupo poblacional del afiliado","Cantidad de registros","Fecha de actualización"]
